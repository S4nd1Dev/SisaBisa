          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-20 grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center w-full">
            ...
            <div className="space-y-7">
              ...
              <p className="text-base md:text-[1.1rem] leading-relaxed text-slate-500 max-w-xl font-medium animate-fade-up" style={{ animationDelay: '160ms' }}>
                SisaBisa membantu mencatat bahan, memantau masa kadaluwarsa,
        ...
        <section className="bg-[#FFEF91]/20 py-16 md:py-24 border-y border-yellow-200/40 overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              ...
              <StepCard step="02" icon={Clock} iconBg="bg-yellow-500" title="Predict" subtitle="Estimasi Expired" description="Sistem menghitung otomatis kapan bahan kamu akan kadaluwarsa berdasarkan storage rules." />
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
            ...
            <FeatureCard
              ...
              description="Dapatkan notifikasi email sebelum bahan kadaluwarsa. Tidak ada lagi bahan yang terbuang karena lupa."
              featured
            />
            <FeatureCard
              icon={ChefHat}
